...
require("knitr")
opts_knit$set(root.dir = '~/Documents/PhD/Thesis/quantseq_dataAnalysis/quantseq_dataAnalysis/deseq2_january2024/scripts/objects/results_4wpc_vs_10wpi')
```
...
## Differential gene expression between 4 week post-challenge (WPC) and 10 weeks post-immunization (WPI)
...
All enrichment analyses use *H. sapiens* orthologs converted from *S. salar* **ENSEMBL** gene IDs.
...
#| fig-cap: 'Downregulated GATA3 pathways between 4WPC and 10WPI'
...
#| fig-cap: Upregulated GATA3 pathways between 4WPC and 10WPI
