...
In this case, I started from genes that were commonly expressed in all treatments in relation to CONU. The summ of the center of both Venn diagrams, since GSEA uses down- and upregulated at the same time, as input.
