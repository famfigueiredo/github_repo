---
title: "Data analysis across treatments at 10 weeks post-immunization, IV-LD as reference"
...
require("knitr")
opts_knit$set(root.dir = '~/Documents/PhD/Thesis/quantseq_dataAnalysis/deseq2_dataAnalysis_2024/results/results_10wpi')
```
...
results_files <-
  ls(pattern = '^res_.*conu.10wpi')  # listing Global Environment files matching regex pattern, to be used in the for loop. In this case, starting with res, containing conu, and 10wpi
...
deg_regulation_summary <-
  deg_regulation_summary %>% add_row(Treatment = 'GATA3',
                                     Regulation = 'downregulated',
                                     n = 0) %>% 
  add_row(Treatment = 'IV-HD',
          Regulation = 'downregulated',
          n = 0)
